...
export default function NewsletterCTA() {
  return (
    <section className='w-full min-h-screen md:min-h-[50vh] overflow-hidden relative flex items-center'>
      ...
      {/* Content Container */}
      <div className='w-full max-w-3xl pb-8 relative rounded-[10px] mx-auto overflow-hidden shadow-[0px_12px_18px_-6px_rgba(0,0,0,0.30)]'>
        ...
        <div className='relative inset-0 z-10 flex flex-col items-center justify-center p-4 pt-12 pb-12 md:p-10 md:pt-14 md:pb-14'>
